		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Armazenar dados?">
					<label for="sim"><input id="sim" type="radio" value="sim" v-model="armazenar"> Sim</label>
					<label for="nao"><input id="nao" type="radio" value="não" v-model="armazenar"> Não</label>
				</Rotulo>
				<hr>
