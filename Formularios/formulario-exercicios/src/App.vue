		...
		<div class="conteudo">
			<form class="painel" v-if="!enviado">
				...
				<Rotulo nome="Qual produto?">
					<label for="web" class="mr-4"><input id="web" type="radio" value="web" v-model="produto"> Web</label>
					<label for="mobile" class="mr-4"><input id="mobile" type="radio" value="mobile" v-model="produto"> Mobile</label>
					<label for="outro"><input id="outro" type="radio" value="outro" v-model="produto"> Outro</label>
				</Rotulo>
				<Rotulo nome="Prioridade">
					<select v-model="prioridade">
						<option v-for="p in prioridades" :key="p.codigo" :value="p.codigo">{{ p.codigo }} - {{ p.nome }}</option>
					</select>
				</Rotulo>
